...
public:
  ...
  // query
  void    query(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_box<T> >& ret, spatial3d::QueryType qt = spatial3d::QueryType::intersects) const;
  ...
  // kNN search
  void    nearestSearch(const Point3d<T>& pt, const Int_t k, Vector_t<spatial3d::b_box<T>>& ret) const;
  void    nearestSearch(const Point3d<T>& p1, const Point3d<T>& p2, const Int_t k, Vector_t<spatial3d::b_box<T>>& ret) const;
...
public:
  ...
  // query
  void    query(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<Value>& ret, spatial3d::QueryType qt = spatial3d::QueryType::intersects) const;
  void    queryBox(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_box<T> >& ret, spatial3d::QueryType qt = spatial3d::QueryType::intersects) const;
  void    queryBoth(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_value<T, Value> >& ret, spatial3d::QueryType qt = spatial3d::QueryType::intersects) const;
  bool    exist(const Point3d<T>& min_corner, const Point3d<T>& max_corner, spatial3d::QueryType qt = spatial3d::QueryType::intersects) const;

  // kNN search
  //void    nearestSearch(const Point3d<T>& pt, const Int_t k, Vector_t<Value>& ret) const;
  //void    nearestSearch(const Point3d<T>& p1, const Point3d<T>& p2, const Int_t k, Vector_t<Value>& ret) const;
};

////////// Spatial3d Implementation /////////////
template<typename T>
void Spatial3d<T>::query(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_box<T> >& ret, spatial3d::QueryType qt) const {
...
template<typename T>
void Spatial3d<T>::nearestSearch(const Point3d<T>& pt, const Int_t k, Vector_t<spatial3d::b_box<T>>& ret) const {
  spatial3d::SearchCallback<spatial3d::b_box<T>> callback(ret);
  _rtree.query(spatial3d::bgi::nearest(pt, k), boost::make_function_output_iterator(callback));
}

template<typename T>
void Spatial3d<T>::nearestSearch(const Point3d<T>& p1, const Point3d<T>& p2, const Int_t k, Vector_t<spatial3d::b_box<T>>& ret) const {
  spatial3d::SearchCallback<spatial3d::b_box<T>> callback(ret);
  _rtree.query(spatial3d::bgi::nearest(spatial3d::b_box<T>(p1, p2), k), boost::make_function_output_iterator(callback));
}

////////// SpatialMap3d Implementation /////////////
template<typename T, typename Value, typename Comp>
void SpatialMap3d<T, Value, Comp>::query(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<Value>& ret, spatial3d::QueryType qt) const {
...
template<typename T, typename Value, typename Comp>
void SpatialMap3d<T, Value, Comp>::queryBox(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_box<T> >& ret, spatial3d::QueryType qt) const {
...
template<typename T, typename Value, typename Comp>
void SpatialMap3d<T, Value, Comp>::queryBoth(const Point3d<T>& min_corner, const Point3d<T>& max_corner, Vector_t<spatial3d::b_value<T, Value> >& ret, spatial3d::QueryType qt) const {
